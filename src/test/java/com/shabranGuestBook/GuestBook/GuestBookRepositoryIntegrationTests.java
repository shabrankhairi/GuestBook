...
class GuestBookRepositoryIntegrationTests {
    ...
    void persistsGuestBookEntry() {
        ...
        GuestBookEntry entry = repository.save(new GuestBookEntry("shabran", "May the force be with you!", ""));
    ...
    void findsGuestBookEntryByAuthorName() {
        ...
        GuestBookEntry entry = repository.save(new GuestBookEntry("Shabran", "", ""));
